...
PM_START_TEXT = """
удобный чат-бот для управления беседами. 🕹
 
"""

buttons = [
    [
        InlineKeyboardButton(text="📌 Владелец", url="https://t.me/isIam07"),
        InlineKeyboardButton(text="🖲 Помощник", url="https://t.me/B0rz07"),
    ],
    [
        InlineKeyboardButton(text="📜 Канал", url="https://t.me/isIam01"),
        InlineKeyboardButton(text="❔ ʜᴇʟᴘ", url="http://t.me/Islam95_bot?start=help"),
    ],
    [
        InlineKeyboardButton(
...
def AnkiVector_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Anki Vector Brother](https://t.me/islam95_bot)."
